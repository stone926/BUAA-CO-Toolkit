...
describe('P7 probe checker', () => {
  ...
  it('checks exact internal exception codes and duplicate records', () => {
    ...
    const sim = [
      ...recordLines(0, [p7ProbeMagic, 1, 5, 0x0002, 0x0010, 0x3020, 0, 0]),
      ...recordLines(1, [p7ProbeMagic, 2, 9, 0x0002, 0x0030, 0x3040, 0, 0]),
      ...recordLines(2, [p7ProbeMagic, 2, 9, 0x0002, 0x0030, 0x3040, 0, 0])
    ].join('\n');
  ...
  it('reports exact internal exception code mismatches', () => {
    ...
    const sim = recordLines(0, [p7ProbeMagic, 1, 7, 0x0002, 0x0028, 0x3020, 0, 0]).join('\n');
