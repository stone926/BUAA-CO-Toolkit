...
export const p7ProbeExternalArmAddress = 0x27d0;
...
export const p7ProbeKindAdel = 5;
export const p7ProbeKindAdes = 6;
export const p7ProbeKindSyscall = 7;
export const p7ProbeKindRi = 8;
export const p7ProbeKindOv = 9;
export const p7ProbeDefaultScenarioCount = 32;
export const p7ProbeMaxScenarioCount = 64;
export const p7ProbeTimerPresetMin = 2;
export const p7ProbeTimerPresetMax = 96;
export const p7ProbeTimerCtrlStart = 0x9;

export const p7ExcCodeAdel = 4;
export const p7ExcCodeAdes = 5;
export const p7ExcCodeSyscall = 8;
export const p7ExcCodeRi = 10;
export const p7ExcCodeOv = 12;
