# Third-party notices for the bundled linux-x64 Icarus runtime

This directory contains the complete Icarus Verilog 13.0 installation prefix
built from the unmodified upstream v13_0 source archive on native linux-x64
...
- Build environment: Ubuntu 22.04, native linux-x64; GCC/G++, make, bison and flex
- C compiler: 11.4.0
- C++ compiler: 11.4.0
